...
parser.add_argument('--trained_model',
                    default='weights/jnet_uad/ssd300_JNET_UAD_95000.pth', type=str,
...
if __name__ == '__main__':
    ...
    # traind SSD model
    args.trained_model = 'weights/ssd300_UAD_10000.pth'
    # images we will deal with for evaluation
    cache_name = 'uad_test_images.npy'
    dataset_name = 'UAD'
    is_train = False
    #is_train = True
    # output directory to save the results in
    output_dir = 'ssd300_jnet'
