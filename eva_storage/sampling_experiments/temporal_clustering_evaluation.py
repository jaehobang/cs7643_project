...
if __name__ == "__main__":
    ...
    temporal_cluster = TemporalClusterModule(downsample_method=DownSampleMeanMethod())
    ...
    sys.stdout = open("/nethome/jbang36/eva_jaeho/eva_storage/sampling_experiments/eval_block_avg_output.txt", "w+")
