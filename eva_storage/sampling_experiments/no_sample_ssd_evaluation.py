...
if __name__ == "__main__":
    ...
    test_dataset.set_images(images)
    test_dataset.set_labels(labels)
    test_dataset.set_boxes(boxes)
    ...
    gt_labels, predicted_labels = do_python_eval_for_uniform_sampling(all_class_recs, nposes,
    ...
    all_gt_labels = convert_labels_to_binary(test_dataset)
    ...
    dict_keys(['car', 'bus', 'others', 'van'])
    hello world
    key: car, score: 0.9330124970891873
    key: bus, score: 0.6987502910812698
    key: others, score: 0.9621982457502135
    key: van, score: 0.6800434681363037
