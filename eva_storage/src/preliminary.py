...
TODO: We will allocate random colors and intersections to the images.
TODO: We will save this data in a txt format in the eva_storage directory. We will need this for benchmarking.
