...
class UNet_final(nn.Module):
    ...
    def create_enc(self):
        ...
        self.u_enc3.add_module('Conv3_1', nn.Conv2d(16, 24, kernel_size=3, padding=(1, 1)))
        self.u_enc3.add_module('Relu3_2', nn.ReLU(True))
        self.u_enc3.add_module('Conv3_3', nn.Conv2d(24, 24, kernel_size=3, padding=(1, 1)))
    ...
    def create_decoder_b(self):
        ...
        self.u_decb1.add_module('CT4_6', nn.ConvTranspose2d(16, 16, kernel_size=2, stride=2))
